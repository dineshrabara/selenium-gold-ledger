...
Scenario('Login and Sale Return Voucher', ({ I }) => {
  I.amOnPage('/login');

//   Sale Return Create
  I.click('Vouchers');
  I.waitForText('Sale Return', 20);
  I.click('Sale Return');
  I.see('Sale Return');
  I.waitForText('Add Voucher', 5);
  I.click('Add Voucher');
  I.waitForText('Create New Sale Return', 3);
  I.see('Create New Sale Return');
  ...
  I.click('Save');
  I.see('sale return created successfully');

//   Sale Return Update
  I.click('Open menu'); 
  I.waitForText('Edit', 5);
  I.click('//div[@role="menuitem" and .//span[text()="Edit"]]');
  I.waitForText('Update Sale Return', 5);
  I.click('Update');
  I.see('sale return updated successfully');
  I.click('Update & Print');
  I.waitForText('Sale Return', 5);
  I.see('Sale Return');
  I.refreshPage();
...
I.click('Delete');
I.see('sale return deleted successfully');
I.click('Filter');
I.click('Clear');
