...
//   Purchase Return Create
  I.click('Vouchers');
  I.waitForText('Purchase Return', 20);
  I.click('Purchase Return');
  I.see('Purchase Return');
  I.waitForText('Add Voucher', 5);
  I.click('Add Voucher');
  I.waitForText('Create New Purchase Return', 3);
  I.see('Create New Purchase Return');
  ...
  I.click('Save');
  I.see('purchase return created successfully');

//   Purchase Return Update
  I.click('Open menu'); 
  I.waitForText('Edit', 5);
  I.click('//div[@role="menuitem" and .//span[text()="Edit"]]');
  I.waitForText('Update Purchase Return', 5);
  I.click('Update');
  I.see('purchase return updated successfully');
  I.click('Update & Print');
  I.waitForText('Purchase Return', 5);
  I.see('Purchase Return');
  I.refreshPage();
...
I.click('Delete');
I.see('purchase return deleted successfully');
I.click('Filter');
I.click('Clear');
